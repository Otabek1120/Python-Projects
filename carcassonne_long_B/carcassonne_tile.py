    ...
    def road_get_connection(self, from_side):
        ...
        if from_side == 3:
            if self.edge_has_road(1):
                return 1
            elif self.edge_has_road(0):
                return 0
            elif self.edge_has_road(2):
                return 2
...
tile13 = CarcassonneTile()
tile13.set_north("city")
tile13.set_east("grass")
tile13.set_east("road")
tile13.set_south("grass")
tile13.set_south("road")
tile13.set_west("grass")
tile13.set_west("road")
tile13.set_center("road")

tile14 = CarcassonneTile()
tile14.set_north("city")
tile14.set_east("city")
tile14.set_south("grass")
tile14.set_west("grass")
tile14.set_center("grass")

tile15 = CarcassonneTile()
tile15.set_north("grass")
tile15.set_east("grass")
tile15.set_south("grass")
tile15.set_south("road")
tile15.set_west("grass")
tile15.set_west("road")
tile15.set_center("grass")

tile16 = CarcassonneTile()
tile16.set_north("city")
tile16.set_east("grass")
tile16.set_south("grass")
tile16.set_west("grass")
tile16.set_center("grass")